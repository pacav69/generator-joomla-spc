...
class <%= _.str.capitalize(_.slugify(componentName)) %>Zipfile
{
	/*
...
//$zipfile = new <%= _.str.capitalize(_.slugify(componentName)) %>Zipfile; // Instantiate object
...
//$zipfile = new zipfile; // Create object
//$zipfile->read_zip($file); // Read the file
//foreach($zipfile->files as $f) { // do something with $f['name'] and $f['data'] }
